<?php
include_once '../../config/Database.php'; //Database.php
include_once '../../classes/User.php'; //User.php
...
// Check if a role was passed in the URL
$default_role = isset($_GET['role']) ? $_GET['role'] : '';
...
<head>
    <meta charset="utf-8">
    <title>DASHMIN - Create User</title>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role" name="role" required>
                                    <option value="admin" <?php echo ($default_role == 'admin') ? 'selected' : ''; ?>>Admin</option>
                                    <option value="vendeur" <?php echo ($default_role == 'vendeur') ? 'selected' : ''; ?>>Vendeur</option>
