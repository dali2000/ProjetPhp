        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0"><?php if(isset($nom)){echo $nom ;} ?></h6>
                        <span>Admin</span>
                    </div>
                </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Events/Categorie</h6>
                                <a href="">Show All</a>
                            </div>
                            <canvas id="events-categorie"></canvas>
                            <script>
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">Répartition de nb inscri Événements par Client</h6>                                <a href="">Show All</a>
                            </div>
                            <canvas id="clients-events"></canvas>
                            <script>
