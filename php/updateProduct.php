...
if(isset($_GET['idE'])){
    $p = $produit->getProduitById($_GET['idE']);
}
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" action="newProduct.php" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nomProduit" name="nomProduit" value="<?php echo $p['nomProduit']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description</label>
                                    <input type="text" class="form-control" id="description" name="description" value="<?php echo $p['description']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="prix" class="form-label">Prix</label>
                                    <input type="text" class="form-control" id="prix" name="prix" value="<?php echo $p['prix']; ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="image" class="form-label">Image</label>
                                    <input class="form-control" type="file" id="image" name="image" value="<?php echo $p['img']; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm mb-3" aria-label=".form-select-sm example" id="cat" name="cat">
                                        <option >choisir une catégorie</option>
                                        <option selected value="<?php echo $p['idCategorie']?>"> <?php echo $cat->getCategorieById($p['idCategorie'])['nomCategorie']; ?></option>
                                        <?php
                                ...
                                <input type="submit" class="btn btn-primary" value="update Produit" name="addE"/>
                            </form>
